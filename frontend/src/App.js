...
const App = () => {
  ...
  useEffect(() => {
    // Apply search and filter logic whenever tasks, searchQuery, or statusFilter changes
    let filtered = tasks;
  ...
  return (
    <div className="p-8 bg-gray-100 min-h-screen">
      ...
      <div className="md:flex md:flex-row gap-8">
        <div className="w-full md:w-1/3 bg-white p-6 rounded-lg mb-10 shadow-lg h-fit">
        ...
        <div className="w-full md:w-2/3 bg-white p-6 rounded-lg shadow-lg">
          ...
          {filteredTasks.map((task) => (
            <div
              className="task bg-blue-50 p-6 rounded-lg border border-blue-200 shadow-md mb-4 flex items-center justify-between"
              key={task.id}
            >
              <div>
      ...
      {/* Edit Modal */}
      {modalVisible && (
        <div className="modal bg-gray-900 bg-opacity-75 fixed inset-0 flex items-center justify-center">
